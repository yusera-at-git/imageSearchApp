  ...
  const filterResultsByLikes = (likes) => {
    return results.filter((result) => {
      ...
      switch (likes) {
        ...
        case 200:
          return result.likes >= likes && result.likes <= 300;
        case 100:
          return result.likes >= likes && result.likes <= 200;
        default:
          return result.likes < 100;
      }
    });
  };
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <ScrollView stickyHeaderHiddenOnScroll={true} stickyHeaderIndices={[0]}>
        ...
        />
        <ResultList
          title="liked by more than 300"
          results={filterResultsByLikes(300)}
        />
        <ResultList
          title="liked by more than 200"
          results={filterResultsByLikes(200)}
        />
        <ResultList
          title="liked by more than 100"
          results={filterResultsByLikes(100)}
        />
        <ResultList
          title="Other Images related to your search!!"
